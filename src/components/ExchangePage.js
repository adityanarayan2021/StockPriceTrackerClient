...
const ExchangePage = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await fetch(
          `http://localhost:3001/getAllStock?keyword=${searchQuery}&page=${page}&limit=${
    ...
    fetchData();
    // Set up an interval to call the fetchData function every minute
